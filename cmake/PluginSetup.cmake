...
if(DEFINED ENV{OCPN_TARGET})
    set(PACKAGING_NAME "${PKG_NVR}_${PKG_TARGET}-${ARCH}-${PKG_TARGET_VERSION}_$ENV{OCPN_TARGET}")
    set(PACKAGING_NAME_XML "${PKG_NVR}_${PKG_TARGET}-${ARCH}-${PKG_TARGET_VERSION}-$ENV{OCPN_TARGET}")
else(DEFINED ENV{OCPN_TARGET})
    set(PACKAGING_NAME "${PKG_NVR}_${PKG_TARGET}-gtk3-${ARCH}-${PKG_TARGET_VERSION}")
    set(PACKAGING_NAME_XML "${PKG_NVR}_${PKG_TARGET}-gtk3-${ARCH}-${PKG_TARGET_VERSION}")
